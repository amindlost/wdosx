...
; ############################################################################
;
; $Header: E:/RCS/WDOSX/0.95/SRC/UTIL/ADDFILE.ASM 1.6 2001/02/22 22:32:02 MikeT Exp $
;
; ----------------------------------------------------------------------------
;
; $Log: ADDFILE.ASM $
; Revision 1.6  2001/02/22 22:32:02  MikeT
; Fix syntax error that crept in during last change.
;
; Revision 1.5  2001/02/22 21:48:40  MikeT
; Fix stack cleanup after WdoxPack call.
;
; Revision 1.4  2001/02/22 21:43:14  MikeT
; New version with wpack 1.07 support.
;
; Revision 1.3  1999/06/20 15:53:36  MikeT
; Changed to use external compressor (Joergen Ibsen's WPACK) instead of the
; internal LZ77 one.
;
; Revision 1.2  1999/02/07 18:20:49  MikeT
...
MAX_MATCH_SIZE EQU 18
MIN_MATCH_SIZE EQU 3
